 ...
 *              When it's invoked, it produces an HTTP response whose MIME type is application/json.
 * Revision history: 
 *                  1) Date modified: Nov 21, 2020 -- Added support for
 *                                   XML error handling. 
 */
...
$xmlRootElement = simplexml_load_file($xml_file_name);
if (!($xmlRootElement instanceof SimpleXMLElement)) {
...
if (isset($_GET["query"]) && !empty($_GET["query"])) {
    ...
    foreach ($xmlRootElement->category as $categories) {
